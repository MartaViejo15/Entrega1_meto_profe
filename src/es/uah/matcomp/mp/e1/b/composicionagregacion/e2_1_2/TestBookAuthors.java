package es.uah.matcomp.mp.e1.b.composicionagregacion.e2_1_2;
...
public class TestBookAuthors {
    public static void main(String[] args) {
        ...
        BookAuthors dummyBook = new BookAuthors("Java for dummy", authors, 19.95, 99); // Test Book's Constructor
...
// Use an anonymous instance of Author to construct a Book instance
        BookAuthors anotherBook = new BookAuthors("more Java",
                authors, 29.95);
